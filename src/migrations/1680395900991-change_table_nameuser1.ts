...
export class changeTableNameUser1680395900991 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "name" ADD CONSTRAINT "PK_c49f64b685ea46b08143674c6d5" PRIMARY KEY ("uuid")`);
    await queryRunner.query(`ALTER TABLE "name" ALTER COLUMN "uuid" SET DEFAULT uuid_generate_v4()`);
    await queryRunner.query(`ALTER TABLE "name" ALTER COLUMN "created_at" SET DEFAULT now()`);
    await queryRunner.query(`ALTER TABLE "name" ALTER COLUMN "updated_at" SET DEFAULT now()`);
  }
